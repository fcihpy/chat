/*!
 ...
 @abstract 关于Manager中登陆相关功能的异步回调
 @author EaseMob Inc.
...
@protocol FCOauthManagerDelegate <FCManagerDelegateBase>
...
/*!
 ...
 @result
 */
- (void)willAutoLoginWithInfo:(NSDictionary *)loginInfo error:(NSError *)error;
...
/*!
 ...
 @result
 */
- (void)didAutoLoginWithInfo:(NSDictionary *)loginInfo error:(NSError *)error;
...
/*!
 ...
 @result
 */
- (void)didLoginWithInfo:(NSDictionary *)loginInfo error:(NSError *)error;
...
/*!
 ...
 @result
 */
- (void)didLogoffWithError:(NSError *)error;
