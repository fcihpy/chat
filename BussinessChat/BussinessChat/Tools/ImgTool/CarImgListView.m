...
#import "CarImgListView.h"
#import "ImageItemView.h"

@implementation CarImgListView
...
- (void)setImagUrls:(NSArray *)imagUrls{
    // 4
    _imagUrls = imagUrls;
    NSInteger count = imagUrls.count;
