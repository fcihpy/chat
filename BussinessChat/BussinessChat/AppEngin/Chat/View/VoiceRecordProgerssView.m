...
@interface VoiceRecordProgerssView ()
{
    NSTimer *myTimer;
    int angle;
...
@implementation VoiceRecordProgerssView

@synthesize overlayWindow;

+(VoiceRecordProgerssView *)sharedView
{
    static VoiceRecordProgerssView *sharedView;
    static dispatch_once_t once;
    dispatch_once(&once, ^{
        sharedView = [[VoiceRecordProgerssView alloc]initWithFrame:[UIScreen mainScreen].bounds];
...
+ (void)show
{
    [[VoiceRecordProgerssView sharedView] show];
}
...
{
    [[VoiceRecordProgerssView sharedView]dismiss:str];
}
...
{
    [[VoiceRecordProgerssView sharedView] setState:str];
}
