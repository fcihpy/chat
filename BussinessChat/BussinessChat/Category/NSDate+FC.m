...
+ (NSString *)stringFromDate:(NSDate *)date formate:(NSString *)formate{
    ...
    [fmt setDateFormat:formate];
    return [fmt stringFromDate:date];
}

+ (NSDate *)dateFromDateStr:(NSString *)dateStr formate:(NSString *)formate{
...
+ (NSString *)formateString:(NSString *)dateString{
    ...
    NSDate *create = [self dateFromDateStr:dateString formate:formate];
  
    return [self stringFromDate:create formate:@"MM-dd HH:mm"];
}
